...
export function PoolGrabber(props: PoolGrabProps): JSX.Element {
    ...
    return (
        <div className="w-11/12 h-full md:w-1/2 absolute bg-red-500 left-6 lg:left-12 xl:left-24 flex flex-col justify-center items-center transition-all overflow-x-visible">
            <PoolGrabIndicator />
